...
values
  ('pita-express', '任选两卷', 'Any 2 Wraps', null, '每日特惠', '', false, '[{"label_zh":"法拉费 ×2","label_en":"Falafel ×2","price":9.99},{"label_zh":"法拉费 + 鸡肉","label_en":"Falafel + Chicken","price":9.99},{"label_zh":"法拉费 + 牛肉","label_en":"Falafel + Beef","price":9.99},{"label_zh":"鸡肉 ×2","label_en":"Chicken ×2","price":9.99},{"label_zh":"鸡肉 + 牛肉","label_en":"Chicken + Beef","price":9.99},{"label_zh":"牛肉 ×2","label_en":"Beef ×2","price":9.99}]'::jsonb, 'sp-2wraps', 0),
  ...
  ('pita-express', '烤串拼盘', 'Kebab Plate', null, '拼盘', '', false, '[{"label_zh":"鸡肉","label_en":"Chicken","price":11.99},{"label_zh":"牛肉","label_en":"Beef","price":11.99}]'::jsonb, 'plate-kebab', 10),
  ...
  ('pita-express', '沙拉', 'Salad', null, '拼盘', '', false, '[{"label_zh":"鸡肉","label_en":"Chicken","price":9.99},{"label_zh":"牛肉","label_en":"Beef","price":9.99}]'::jsonb, 'plate-salad', 13),
  ...
  ('pita-express', '墨西哥卷', 'Burrito', null, '墨西哥卷', '', false, '[{"label_zh":"鸡肉","label_en":"Chicken","price":9.99},{"label_zh":"牛肉","label_en":"Beef","price":9.99}]'::jsonb, 'burrito-cb', 17),
  ('pita-express', '沙威玛卷套餐（含薯条+饮料）', 'Shawarma Wrap Combo (+ fries & drink)', null, '套餐', '', false, '[{"label_zh":"鸡肉","label_en":"Chicken","price":9.99},{"label_zh":"牛肉","label_en":"Beef","price":9.99}]'::jsonb, 'combo-wrap', 18),
  ('pita-express', '鸡块套餐（含薯条+饮料）', 'Chicken Nuggets Combo (+ fries & drink)', 9.99, '套餐', '', false, '[]'::jsonb, 'combo-nuggets', 19),
  ('pita-express', '炸鱼卷套餐（含薯条+饮料）', 'Fish Wrap Combo (+ fries & drink)', 9.99, '套餐', '', false, '[]'::jsonb, 'combo-fish-wrap', 20),
  ('pita-express', '汉堡套餐（含薯条+饮料）', 'Burger Combo (+ fries & drink)', null, '套餐', '', false, '[{"label_zh":"鸡肉","label_en":"Chicken","price":9.99},{"label_zh":"牛肉","label_en":"Beef","price":9.99}]'::jsonb, 'combo-burger', 21),
  ('pita-express', '法拉费卷套餐（含薯条+饮料）', 'Falafel Wrap Combo (+ fries & drink)', 9.99, '套餐', '', false, '[]'::jsonb, 'combo-falafel', 22),
  ('pita-express', '热狗套餐（含薯条+饮料）', 'Hotdog Combo (+ fries & drink)', 9.99, '套餐', '', false, '[]'::jsonb, 'combo-hotdog', 23),
  ('pita-express', '烤串卷套餐（含薯条+饮料）', 'Kebab Wrap Combo (+ fries & drink)', 9.99, '套餐', '', false, '[]'::jsonb, 'combo-kebab', 24),
  ('pita-express', '鸡米花套餐（含薯条+饮料）', 'Popcorn Chicken Combo (+ fries & drink)', 9.99, '套餐', '', false, '[]'::jsonb, 'combo-popcorn', 25),
  ('pita-express', '双拼沙威玛卷套餐（含薯条+饮料）', 'Mix Shawarma Wrap Combo (+ fries & drink)', 9.99, '套餐', '', false, '[]'::jsonb, 'combo-mix-wrap', 26),
  ('pita-express', '鸡柳套餐（含薯条+饮料）', 'Chicken Tender Combo (+ fries & drink)', 9.99, '套餐', '', false, '[]'::jsonb, 'combo-tenders', 27),
  ('pita-express', '鱼块套餐（含薯条+饮料）', 'Fish Nuggets Combo (+ fries & drink)', 10.99, '套餐', '', false, '[]'::jsonb, 'combo-fish-nuggets', 28),
  ...
  ('pita-express', '汉堡', 'Burger', null, '汉堡', '', false, '[{"label_zh":"鸡肉","label_en":"Chicken","price":6.99},{"label_zh":"牛肉","label_en":"Beef","price":6.99}]'::jsonb, 'burger-cb', 51),
