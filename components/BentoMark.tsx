...
// favicon (lib/pwaIcon.tsx / app/icon.tsx): an emerald tile with one big white
// compartment + two stacked, the top-right one a warm gold (#F2C14E) accent —
// a subtle "there's food in here" pop. Rendered as inline SVG so it scales
...
export function BentoMark({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 48 48" className={className} aria-hidden="true" focusable="false">
      ...
      <rect x="28" y="9" width="11" height="13.5" rx="4" fill="#F2C14E" />
