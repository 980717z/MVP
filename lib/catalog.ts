...
export const MODULES: ModuleDef[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "priority", label: { zh: "紧急程度", en: "Priority" }, type: "select", half: true,
        options: [{ zh: "紧急", en: "Urgent" }, { zh: "普通", en: "Normal" }] },
      { key: "vendor", label: { zh: "维修方", en: "Vendor" }, type: "text", half: true },
      { key: "cost", label: { zh: "费用", en: "Cost" }, type: "money", half: true },
      { key: "status", label: { zh: "状态", en: "Status" }, type: "select", half: true,
        options: [{ zh: "待处理", en: "Open" }, { zh: "处理中", en: "In progress" }, { zh: "已完成", en: "Done" }, { zh: "停用", en: "Retired" }] },
